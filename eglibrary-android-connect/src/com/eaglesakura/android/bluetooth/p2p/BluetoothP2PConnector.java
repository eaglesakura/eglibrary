...
public abstract class BluetoothP2PConnector {
    ...
    public interface P2PConnectorListener {
         ...
         * @param buffer
         */
        public void onDataReceived(BluetoothP2PConnector self, byte[] buffer);
         ...
         * @param pack
         */
        public void onDataSended(BluetoothP2PConnector self, DataPackage pack);
         ...
         * @param state
         */
        public void onConnectorStateChanged(BluetoothP2PConnector self, ConnectorType type, ConnectorState state);
    }
}
