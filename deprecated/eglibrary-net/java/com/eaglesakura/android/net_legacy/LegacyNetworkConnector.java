 ...
 */
@Deprecated
public class LegacyNetworkConnector {
    ...
    public LegacyNetworkConnector(Context context) {
        context = context.getApplicationContext();
        synchronized (LegacyNetworkConnector.class) {
            if (requests == null) {
            ...
            public RetryPolicy newRetryPolycy(final String url, String method) {
                return new DefaultRetryPolicy(5000, 10, 1.2f) {
                    ...
                    public void retry(VolleyError error) throws VolleyError {
                        LogUtil.log("%s retry(%s)", LegacyNetworkConnector.this.getClass().getSimpleName(), url);
                        super.retry(error);
                    }
                };
            }
    ...
    protected <T> LegacyNetworkResult<T> connect(final String url, final RequestParser<T> parser, final int volleyMethod, IConnectParams params) {
        ...
        LegacyNetworkResult<T> result = new VolleyNetworkResult<>(url, this, parser, volleyMethod, params);
        start(result);
        return result;
    }
...
//    static final int CACHETYPE_FILE = 1;
    ...
    class CacheDatabase extends DaoDatabase<DaoSession> {
        public CacheDatabase() {
            super(LegacyNetworkConnector.this.context, DaoMaster.class);
        }
        ...
        protected SQLiteOpenHelper createHelper() {
            return new SQLiteOpenHelper(context, cacheFile != null ? cacheFile.getAbsolutePath() : null, null, SUPPORTED_DATABASE_VERSION) {
                ...
                public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
                    ...
                    LogUtil.log("%s db update(%d -> %d) drop", LegacyNetworkConnector.this.getClass().getSimpleName(), oldVersion, newVersion);
    ...
    private static LegacyNetworkConnector defaultConnector;

    public static LegacyNetworkConnector getDefaultConnector() {
        synchronized (LegacyNetworkConnector.class) {
    ...
    public static void initializeDefaultConnector(Context context) {
        synchronized (LegacyNetworkConnector.class) {
            if (defaultConnector == null) {
                defaultConnector = new LegacyNetworkConnector(context);
            }
        }
    }
    ...
    public static RequestParser<Object> VOID_PARSER = new RequestParser<Object>() {
        @Override
        public Object parse(LegacyNetworkResult<Object> sender, InputStream data) throws Exception {
            return new Object();
        }
    };
    ...
    public static RequestParser<String> STRING_PARSER = new RequestParser<String>() {
        @Override
        public String parse(LegacyNetworkResult<String> sender, InputStream data) throws Exception {
    ...
    public static RequestParser<byte[]> BYTEARRAY_PARSER = new RequestParser<byte[]>() {
        @Override
        public byte[] parse(LegacyNetworkResult<byte[]> sender, InputStream data) throws Exception {
    ...
    public static class JsonParser<T> implements RequestParser<T> {
        ...
        @Override
        public T parse(LegacyNetworkResult<T> sender, InputStream data) throws Exception {
    ...
    public static class ScaledImageParser implements RequestParser<Bitmap> {
        ...
        @Override
        public Bitmap parse(LegacyNetworkResult<Bitmap> sender, InputStream data) throws Exception {
